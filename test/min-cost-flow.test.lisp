...
(with-test (:name min-cost-flow)
  (let ((graph (make-array '(5) :element-type 'list :initial-element nil)))
    (add-edge! 0 1 10 2 graph)
    (add-edge! 0 2 2 4 graph)
    (add-edge! 1 2 6 6 graph)
    (add-edge! 1 3 6 2 graph)
    (add-edge! 3 2 3 3 graph)
    (add-edge! 3 4 8 6 graph)
    (add-edge! 2 4 5 2 graph)
