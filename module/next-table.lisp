...
VECTOR[NEXT[index]] is the first element equal to VECTOR[index] after the
index. Note that this function deals with VECTOR in a circular manner: e.g. #(3
2 3 1) |-> #(2 1 0 3).

If double is true, this function traverses the concatenation of two VECTORs
instead. #(3 2 3 1) |-> #(2 5 4 7)"
