...
(eval-when (:compile-toplevel :load-toplevel :execute)
  ...
  (defparameter *moduli-table*
    (make-array
     ...
     :initial-contents
     '(4294967291 4294967279 4294967231 4294967197 4294967189 4294967161 4294967143
  ...
  (defparameter *base-table*
    (make-array
     ...
     :element-type '(unsigned-byte 32)
     :initial-contents
     '(2247433164 2139372809 2609807693 2343117402 3096734379 2843084587 3022604264
  ...
  ;; NOTE: Initial random state can be deterministic. (e.g. SBCL)
