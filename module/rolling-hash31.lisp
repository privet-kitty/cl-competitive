...
(eval-when (:compile-toplevel :load-toplevel :execute)
  ...
  (defparameter *moduli-table*
    (make-array
     ...
     :initial-contents
     '(2147483647 2147483629 2147483587 2147483579 2147483563 2147483549 2147483543
  ...
  (defparameter *base-table*
    (make-array
     ...
     :element-type '(unsigned-byte 31)
     :initial-contents
     '(1059428526 2090066834 1772913519 1695158082 1516083910 1622025757 1248368302
