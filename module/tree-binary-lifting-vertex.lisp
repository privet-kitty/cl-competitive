(defpackage :cp/tree-binary-lifting-vertex
  (:use :cl)
  (:export #:two-vertices-disconnected-error #:define-tree-binary-lifting-vertex))
(in-package :cp/tree-binary-lifting-vertex)
...
(defmacro define-tree-binary-lifting-vertex
...
WEIGHTS[v] := weight assigned to vertex v
